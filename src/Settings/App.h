...
namespace Rutile {
    struct App {
        ...
        inline static Scene scene = SceneManager::GetScene(SceneType::MULTI_SHADOW_CASTER_SHADOW_MAP_TESTING_SCENE);
        inline static SceneType currentSceneType = SceneType::MULTI_SHADOW_CASTER_SHADOW_MAP_TESTING_SCENE;
